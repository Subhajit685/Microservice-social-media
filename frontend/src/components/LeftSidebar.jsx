        ...
        {setting && (
          <div
            className={`absolute bottom-0 left-10 w-32 ${
              color === "light" ? "bg-white" : "bg-slate-800 shadow-slate-500"
            } shadow-md rounded-md flex flex-col items-center justify-center z-30`}
          >
            <div className="text-xl py-2" onClick={hendleLogout}>
              Logout
            </div>
            ...
            <div className="text-xl py-2" onClick={chengeTheam}>
            ...
            <div className="text-xl py-2" onClick={() => setsetting(!setting)}>
              Close
            </div>
          </div>
        )}
